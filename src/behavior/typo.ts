...
export function applyTypo(text: string, layout: "azerty" | "qwerty"): { text: string; original: string; corrected: string } | null {
...
export function applyLetterSwap(text: string): { text: string; original: string; corrected: string } | null {
  const words = text.split(/\s+/)
