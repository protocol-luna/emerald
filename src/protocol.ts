...
export type InEvent = MessageEvent | ReadyEvent | BotMessageEvent | PresenceEvent
...
export type OutCommand = RespondCommand | TypingCommand | SetPresenceCommand | SpontaneousCommand | ForgotCommand

export type WsMessage = { event: "command"; command: OutCommand } | { event: "ack"; ackId: string }
