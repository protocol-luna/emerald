...
import { InEvent, WsMessage, OutCommand } from "./protocol"
import { Brain, Decision } from "./brain"
...
export class EmeraldServer {
  ...
  start() {
    ...
    const port = typeof addr === "string" ? parseInt(addr.split(":")[1]) : addr?.port ?? "(unknown)"
